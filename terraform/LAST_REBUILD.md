...
|-------|-------|
| **Container** | `terraform` |
| **Version Change** | `1.13.4` → `1.14.0` |
| **Change Type** | `minor` |
| **Rebuild Date** | 2025-11-19T18:11:30Z |
| **Triggered By** | Upstream Monitor (automated) |
| **Reason** | 🚀 Minor/patch version update detected |
| **Detection Run** | [View Workflow](https://github.com/oorabona/docker-containers/actions/runs/19511697648) |
