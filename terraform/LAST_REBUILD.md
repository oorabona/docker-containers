...
|-------|-------|
| **Container** | `terraform` |
| **Version Change** | `1.13.4` → `1.14.1` |
| **Change Type** | `minor` |
| **Rebuild Date** | 2025-12-03T18:11:50Z |
| **Triggered By** | Upstream Monitor (automated) |
| **Reason** | 🚀 Minor/patch version update detected |
| **Detection Run** | [View Workflow](https://github.com/oorabona/docker-containers/actions/runs/19904091881) |
