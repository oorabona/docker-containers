...
|-------|-------|
| **Container** | `terraform` |
| **Version Change** | `1.13.4` → `1.14.3` |
| **Change Type** | `minor` |
| **Rebuild Date** | 2025-12-17T18:13:13Z |
| **Triggered By** | Upstream Monitor (automated) |
| **Reason** | 🚀 Minor/patch version update detected |
| **Detection Run** | [View Workflow](https://github.com/oorabona/docker-containers/actions/runs/20312772983) |
