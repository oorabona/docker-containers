...
#   When parent X merges, the resolver must:
#   1. Remove cascade:waiting-for-X from the child.
#   2. Re-query the child's remaining cascade:waiting-for-* labels.
...
# ---------------------------------------------------------------------------
# Scenario 5 — branch name extraction: resolver identifies container from HEAD_REF
# These tests validate the shell arithmetic in the "Identify parent container" step.
# ---------------------------------------------------------------------------
