...
teardown() {
    unset BASELINE_FAILED BASELINE_VALID CONTAINER_SCOPES_INPUT REQUESTED_CONTAINER REBUILD_MODE FORCE_REBUILD GITHUB_ACTION_PATH GITHUB_OUTPUT GITHUB_WORKSPACE RUNNER_TEMP TEST_CHANGED_FILES
    teardown_temp_dir
}
